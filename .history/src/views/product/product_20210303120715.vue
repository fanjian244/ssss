<template>
  <div>
    ...
    <Table :columns="columns1" :data="value2">
      ...
      <template slot-scope="{ row }" slot="conts">
        <Switch size="small" v-model="switch1"  />
      </template>
    ...
    <!-- 修改商品 -->
    <Modal v-model="dialogFormVisible" draggable scrollable title="修改商品" @on-ok="ok">
      <Form ref="formValidate" :model="formValidate" :label-width="80">
        <FormItem label="名称" prop="index"></FormItem>
    ...
    <Page :total="3" size="small" show-total show-elevator show-sizer />
  </div>
</template>
